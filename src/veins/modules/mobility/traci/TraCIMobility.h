...
public:
    ...
    virtual void nextPosition(const Coord& position, std::string road_id = "", double speed = -1, Heading heading = Heading::nan, VehicleSignalSet signals = {VehicleSignal::undefined}, std::string objectId = "");
    virtual void changePosition(std::string objectId = "", std::string road_id = "");
