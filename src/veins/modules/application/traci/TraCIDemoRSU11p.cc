...
void TraCIDemoRSU11p::onTask(Task* frame)
{
    ...
    if (toString(newTask->getTarget()) == toString(curPosition)){
        ...
        std::string command = "C:\\Users\\29701\\anaconda3\\python.exe rsuDecision.py " + rsuInfo + " " + toString(newTask->getSenderPos()) + " " + toString(newTask->getDeadlinePos()) + " " + toString(newTask->getCPU()) + " " + toString(newTask->getMem()) + " " + externalId + " " + newTask->getRoadId() + " " + toString(curPosition);
